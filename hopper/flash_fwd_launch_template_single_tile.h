...
void run_flash_fwd_with_scheduler_single_tile(Flash_fwd_params &params, cudaStream_t stream) {
...
void run_mha_fwd_with_scheduler_single_tile_(Flash_fwd_params &params, cudaStream_t stream) {
                ...
                BOOL_SWITCH(params.qv_ptr, HasQV_, [&] {
                    ...
                    APPENDKV_SWITCH(params.knew_ptr, AppendKV, [&] {
                        ...
                        CLUSTER_SWITCH(cutlass::ceil_div(params.seqlen_q * (!PackGQA ? 1 : params.h / params.h_k), kBlockM) % 2 == 0, Use_cluster, [&] {
                            ...
                            run_flash_fwd_with_scheduler_single_tile<Arch, kHeadDim, kHeadDimV, ClusterM, T, T_out, Is_causal, Is_local, Has_softcap, Varlen, PagedKVNonTMA, AppendKV && Varlen, HasQv, PackGQA, Split, V_colmajor>(params, stream);
                        });
                    });
                });
            });
